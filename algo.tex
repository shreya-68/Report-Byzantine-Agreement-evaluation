...
\subsection{Algorithms\protect\footnote{The algorithms and protocols presented here have been reproduced, paraphrased, condensed from works of \cite{BPV06}, \cite{KM13} and \cite{BGH13}.}}
