...
performance of two randomized byzantine agreement algorithms, one using the {\em pull-push}
approach and another using the concept of {\em quorums}, and a third recent
simple deterministic byzantine agreement algorithm. Through implementation on a testbed
...
quantify the performance of each algorithm. In terms of bit complexity, we show that for small
networks $(n < 32)$ and up to $10\%$ faulty processes, the simple
